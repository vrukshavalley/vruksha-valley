      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <div className="w-full h-40 rounded-lg overflow-hidden border border-[#C5A059]/30 bg-white/5 relative group">
             <iframe 
               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3882.345678901234!2d75.3456789!3d13.2345678!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDE0JzA0LjQiTiA3NcKwMjAnNDQuNCJF!5e0!3m2!1sen!2sin!4v1234567890"
          ...
          <p className="text-[10px] text-white/50 mt-3 text-right">
            <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer"
               className="hover:text-[#C5A059] transition-colors flex items-center justify-end gap-1">
              Get Directions →
            </a>
          </p>
        </div>
