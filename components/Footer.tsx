...
export default function Footer() {
  // Analysis Fix: Two distinct links for better UX
  // 1. Explore Link: Opens the general place info and reviews
  const exploreUrl = "https://www.google.com/maps/search/?api=1&query=Vruksha+Valley+Resort+Kalasa";
  // 2. Directions Link: Opens GPS navigation directly
    ...
    <footer id="contact" className="bg-[#051610] text-white border-t border-[#C5A059]/20 pt-16 pb-10 font-serif">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          {/* Action 2: Click the link to "Get Directions" (GPS) */}
