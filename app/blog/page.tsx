...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Travel Journal | Kalasa & Western Ghats Guides — Vruksha Valley",
    description: "Explore Soormane Falls, Netravati Peak, and Horanadu Temple through our travel guides from Vruksha Valley Resort.",
    url: 'https://vrukshavalley.com/blog',
    images: [{ url: '/logo.png', width: 1200, height: 630, alt: 'Vruksha Valley Travel Journal' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: "Travel Journal | Kalasa & Western Ghats Guides",
    description: "Soormane Falls, Netravati Peak trekking, Horanadu Temple — travel guides from Vruksha Valley Resort.",
    images: ['/logo.png'],
  },
};
